...
const handleSubmit =()=>{
 ...
 return (
    <div className="form  text-dark p-2 border border-dark rounded">
  ...
  <button onClick={()=>handleSubmit()}  class="btn border border-dark text-dark my-2 d-block  m-auto px-4">Submit</button>
    </div>
